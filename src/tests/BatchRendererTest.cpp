...
void BatchRendererTest::generateTestData() {
  ...
  // clang-format off >:[ YOU ARE NOT HELPING
...
void BatchRendererTest::defaults() {
  esp::gfx::BatchRendererStandalone renderer{
      esp::gfx::BatchRendererConfiguration{}.setTileSizeCount({48, 32}, {2, 3}),
      esp::gfx::BatchRendererStandaloneConfiguration{}
      /* No QuietLog, to verify at least once that the log *can* be printed */
  };
...
void BatchRendererTest::singleMesh() {
  esp::gfx::BatchRendererStandalone renderer{
      esp::gfx::BatchRendererConfiguration{}.setTileSizeCount({128, 96},
                                                              {1, 1}),
      esp::gfx::BatchRendererStandaloneConfiguration{}.setFlags(
          esp::gfx::BatchRendererStandaloneFlag::QuietLog)};
...
void BatchRendererTest::multipleScenes() {
  esp::gfx::BatchRendererStandalone renderer{
      esp::gfx::BatchRendererConfiguration{}.setTileSizeCount({64, 48}, {2, 2}),
      esp::gfx::BatchRendererStandaloneConfiguration{}.setFlags(
          esp::gfx::BatchRendererStandaloneFlag::QuietLog)};
